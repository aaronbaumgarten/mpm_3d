...
/*----------------------------------------------------------------------------*/
//
void CartesianQuadraticCustom::init(Job* job){
...
void CartesianQuadraticCustom::hiddenInit(Job* job){
...
/*----------------------------------------------------------------------------*/
//
std::string CartesianQuadraticCustom::saveState(Job* job, Serializer* serializer, std::string filepath){
    return "err";
}

int CartesianQuadraticCustom::loadState(Job* job, Serializer* serializer, std::string fullpath){
    return 0;
}
...
/*----------------------------------------------------------------------------*/
//
void CartesianQuadraticCustom::fixPosition(Job* job, KinematicVector& xIN){
...
int CartesianQuadraticCustom::whichElement(Job* job, KinematicVector& xIN){
...
bool CartesianQuadraticCustom::inDomain(Job* job, KinematicVector& xIN){
    //adjust xIN
    KinematicVector tmpX = xIN;
    fixPosition(job,tmpX);
...
/*----------------------------------------------------------------------------*/
//
void CartesianQuadraticCustom::evaluateBasisFnValue(Job* job, KinematicVector& xIN, std::vector<int>& nID, std::vector<double>& nVAL){
    KinematicVector tmpX = xIN;
    fixPosition(job,tmpX);
...
void CartesianQuadraticCustom::evaluateBasisFnGradient(Job* job, KinematicVector& xIN, std::vector<int>& nID, KinematicVectorArray& nGRAD){
    KinematicVector tmpX = xIN;
    fixPosition(job,tmpX);
